...
<p class="text-white font-mono text-sm m-0 pt-0">The wind through my hair</p>
...
<p class="text-white font-mono text-sm">And the world blurring around me.</p>
...
<p class="text-white font-mono text-sm m-0 pt-0">Moves me along these roads.</p>
<p class="text-white font-mono text-sm m-0 pt-0">
...
<p class="text-white font-mono text-sm m-0 pt-0">For this is the only time,</p>
<p class="text-white font-mono text-sm m-0 pt-0">
...
<p class="text-white font-mono text-sm m-0 pt-0">For it is the focal point,</p>
<p class="text-white font-mono text-sm m-0 pt-0">
...
<p class="text-white font-mono text-sm m-0 pt-0">What is your destination?</p>
<br />